...
ADDITIONAL_LLDB_COMMANDS_PATH = pathlib.Path(".bsp/skbsp_generated/lldb_additional_commands.json")
...
def load_additional_lldb_commands() -> list[str]:
    if not ADDITIONAL_LLDB_COMMANDS_PATH.exists():
        return []
    return json.loads(ADDITIONAL_LLDB_COMMANDS_PATH.read_text())
