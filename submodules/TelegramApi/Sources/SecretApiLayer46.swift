...
fileprivate let parsers: [Int32 : (BufferReader) -> Any?] = {
    ...
    dict[-1132882121] = { return SecretApi46.Bool.parse_boolFalse($0) }
    dict[-1720552011] = { return SecretApi46.Bool.parse_boolTrue($0) }
    ...
    dict[-860719551] = { return SecretApi46.DecryptedMessageAction.parse_decryptedMessageActionTyping($0) }
    ...
    dict[-44119819] = { return SecretApi46.SendMessageAction.parse_sendMessageCancelAction($0) }
    dict[1653390447] = { return SecretApi46.SendMessageAction.parse_sendMessageChooseContactAction($0) }
    dict[393186209] = { return SecretApi46.SendMessageAction.parse_sendMessageGeoLocationAction($0) }
    dict[-718310409] = { return SecretApi46.SendMessageAction.parse_sendMessageRecordAudioAction($0) }
    dict[-1584933265] = { return SecretApi46.SendMessageAction.parse_sendMessageRecordVideoAction($0) }
    dict[381645902] = { return SecretApi46.SendMessageAction.parse_sendMessageTypingAction($0) }
    dict[-424899985] = { return SecretApi46.SendMessageAction.parse_sendMessageUploadAudioAction($0) }
    dict[-1884362354] = { return SecretApi46.SendMessageAction.parse_sendMessageUploadDocumentAction($0) }
    dict[-1727382502] = { return SecretApi46.SendMessageAction.parse_sendMessageUploadPhotoAction($0) }
    dict[-1845219337] = { return SecretApi46.SendMessageAction.parse_sendMessageUploadVideoAction($0) }
    return dict
}()
...
public struct SecretApi46 {
    ...
    public static func serializeObject(_ object: Any, buffer: Buffer, boxed: Swift.Bool) {
        switch object {
        case let _1 as SecretApi46.Bool:
        ...
        case let _1 as SecretApi46.PhotoSize:
            _1.serialize(buffer, boxed)
        case let _1 as SecretApi46.SendMessageAction:
            _1.serialize(buffer, boxed)
        default:
            break
        }
    ...
    public enum Bool {
        ...
        fileprivate static func parse_boolFalse(_ reader: BufferReader) -> Bool? {
            return SecretApi46.Bool.boolFalse
        }
        fileprivate static func parse_boolTrue(_ reader: BufferReader) -> Bool? {
            return SecretApi46.Bool.boolTrue
        }
    }
    ...
    public enum DecryptedMessageAction {
        ...
        case decryptedMessageActionTyping(action: SecretApi46.SendMessageAction)
        ...
        fileprivate static func parse_decryptedMessageActionTyping(_ reader: BufferReader) -> DecryptedMessageAction? {
            var _1: SecretApi46.SendMessageAction?
            if let signature = reader.readInt32() {
                _1 = SecretApi46.parse(reader, signature: signature) as? SecretApi46.SendMessageAction
            }
            let _c1 = _1 != nil
            if _c1 {
                return SecretApi46.DecryptedMessageAction.decryptedMessageActionTyping(action: _1!)
            }
            else {
                return nil
            }
