...
fileprivate let parsers: [Int32 : (BufferReader) -> Any?] = {
    ...
    dict[-1132882121] = { return SecretApi8.Bool.parse_boolFalse($0) }
    dict[-1720552011] = { return SecretApi8.Bool.parse_boolTrue($0) }
...
public struct SecretApi8 {
    ...
    public static func serializeObject(_ object: Any, buffer: Buffer, boxed: Swift.Bool) {
        switch object {
        case let _1 as SecretApi8.Bool:
