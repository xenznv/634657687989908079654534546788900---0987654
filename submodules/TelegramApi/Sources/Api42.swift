...
public extension Api.functions.account {
    static func deleteWebBrowserSettingsExceptions() -> (FunctionDescription, Buffer, DeserializeFunctionResponse<Api.account.WebBrowserSettings>) {
        let buffer = Buffer()
        buffer.appendInt32(-2036304291)
        return (FunctionDescription(name: "account.deleteWebBrowserSettingsExceptions", parameters: []), buffer, DeserializeFunctionResponse { (buffer: Buffer) -> Api.account.WebBrowserSettings? in
            let reader = BufferReader(buffer)
            var result: Api.account.WebBrowserSettings?
            if let signature = reader.readInt32() {
                result = Api.parse(reader, signature: signature) as? Api.account.WebBrowserSettings
            }
            return result
        })
    }
...
public extension Api.functions.account {
    static func getWebBrowserSettings(hash: Int64) -> (FunctionDescription, Buffer, DeserializeFunctionResponse<Api.account.WebBrowserSettings>) {
        let buffer = Buffer()
        buffer.appendInt32(1449482088)
        serializeInt64(hash, buffer: buffer, boxed: false)
        return (FunctionDescription(name: "account.getWebBrowserSettings", parameters: [("hash", ConstructorParameterDescription(hash))]), buffer, DeserializeFunctionResponse { (buffer: Buffer) -> Api.account.WebBrowserSettings? in
            let reader = BufferReader(buffer)
            var result: Api.account.WebBrowserSettings?
            if let signature = reader.readInt32() {
                result = Api.parse(reader, signature: signature) as? Api.account.WebBrowserSettings
...
public extension Api.functions.account {
    static func updateWebBrowserSettings(flags: Int32) -> (FunctionDescription, Buffer, DeserializeFunctionResponse<Api.account.WebBrowserSettings>) {
        let buffer = Buffer()
        buffer.appendInt32(-1696627970)
        serializeInt32(flags, buffer: buffer, boxed: false)
        return (FunctionDescription(name: "account.updateWebBrowserSettings", parameters: [("flags", ConstructorParameterDescription(flags))]), buffer, DeserializeFunctionResponse { (buffer: Buffer) -> Api.account.WebBrowserSettings? in
            let reader = BufferReader(buffer)
            var result: Api.account.WebBrowserSettings?
            if let signature = reader.readInt32() {
                result = Api.parse(reader, signature: signature) as? Api.account.WebBrowserSettings
...
public extension Api.functions.auth {
    static func importBotAuthorization(flags: Int32, apiId: Int32, apiHash: String, botAuthToken: String) -> (FunctionDescription, Buffer, DeserializeFunctionResponse<Api.auth.Authorization>) {
        ...
        return (FunctionDescription(name: "auth.importBotAuthorization", parameters: [("flags", ConstructorParameterDescription(flags)), ("apiId", ConstructorParameterDescription(apiId)), ("apiHash", ConstructorParameterDescription(apiHash)), ("botAuthToken", ConstructorParameterDescription("[REDACTED]"))]), buffer, DeserializeFunctionResponse { (buffer: Buffer) -> Api.auth.Authorization? in
            let reader = BufferReader(buffer)
            var result: Api.auth.Authorization?
            if let signature = reader.readInt32() {
                result = Api.parse(reader, signature: signature) as? Api.auth.Authorization
...
public extension Api.functions.bots {
    static func setJoinChatResults(queryId: Int64, result: Api.JoinChatBotResult) -> (FunctionDescription, Buffer, DeserializeFunctionResponse<Api.Bool>) {
        let buffer = Buffer()
        buffer.appendInt32(-417708016)
        serializeInt64(queryId, buffer: buffer, boxed: false)
        result.serialize(buffer, true)
        return (FunctionDescription(name: "bots.setJoinChatResults", parameters: [("queryId", ConstructorParameterDescription(queryId)), ("result", ConstructorParameterDescription(result))]), buffer, DeserializeFunctionResponse { (buffer: Buffer) -> Api.Bool? in
            let reader = BufferReader(buffer)
            var result: Api.Bool?
            if let signature = reader.readInt32() {
                result = Api.parse(reader, signature: signature) as? Api.Bool
...
public extension Api.functions.channels {
    static func joinChannel(channel: Api.InputChannel) -> (FunctionDescription, Buffer, DeserializeFunctionResponse<Api.messages.ChatInviteJoinResult>) {
        let buffer = Buffer()
        buffer.appendInt32(2137660962)
        channel.serialize(buffer, true)
        return (FunctionDescription(name: "channels.joinChannel", parameters: [("channel", ConstructorParameterDescription(channel))]), buffer, DeserializeFunctionResponse { (buffer: Buffer) -> Api.messages.ChatInviteJoinResult? in
            let reader = BufferReader(buffer)
            var result: Api.messages.ChatInviteJoinResult?
            if let signature = reader.readInt32() {
                result = Api.parse(reader, signature: signature) as? Api.messages.ChatInviteJoinResult
            }
            return result
        })
    }
...
public extension Api.functions.channels {
    static func toggleJoinRequest(flags: Int32, channel: Api.InputChannel, enabled: Api.Bool, guardBot: Api.InputUser?) -> (FunctionDescription, Buffer, DeserializeFunctionResponse<Api.Updates>) {
        let buffer = Buffer()
        buffer.appendInt32(248260120)
        serializeInt32(flags, buffer: buffer, boxed: false)
        channel.serialize(buffer, true)
        enabled.serialize(buffer, true)
        if Int(flags) & Int(1 << 0) != 0 {
            guardBot!.serialize(buffer, true)
        }
        return (FunctionDescription(name: "channels.toggleJoinRequest", parameters: [("flags", ConstructorParameterDescription(flags)), ("channel", ConstructorParameterDescription(channel)), ("enabled", ConstructorParameterDescription(enabled)), ("guardBot", ConstructorParameterDescription(guardBot))]), buffer, DeserializeFunctionResponse { (buffer: Buffer) -> Api.Updates? in
            let reader = BufferReader(buffer)
            var result: Api.Updates?
            if let signature = reader.readInt32() {
                result = Api.parse(reader, signature: signature) as? Api.Updates
...
public extension Api.functions.messages {
    static func composeRichMessageWithAI(flags: Int32, text: Api.InputRichMessage?, translateToLang: String?, tone: Api.InputAiComposeTone?) -> (FunctionDescription, Buffer, DeserializeFunctionResponse<Api.messages.ComposedRichMessageWithAI>) {
        ...
        return (FunctionDescription(name: "messages.composeRichMessageWithAI", parameters: [("flags", ConstructorParameterDescription(flags)), ("text", ConstructorParameterDescription(text)), ("translateToLang", ConstructorParameterDescription(translateToLang)), ("tone", ConstructorParameterDescription(tone))]), buffer, DeserializeFunctionResponse { (buffer: Buffer) -> Api.messages.ComposedRichMessageWithAI? in
            let reader = BufferReader(buffer)
            var result: Api.messages.ComposedRichMessageWithAI?
            if let signature = reader.readInt32() {
                result = Api.parse(reader, signature: signature) as? Api.messages.ComposedRichMessageWithAI
            }
            return result
        })
    }
...
public extension Api.functions.messages {
    static func editInlineBotMessage(flags: Int32, id: Api.InputBotInlineMessageID, message: String?, media: Api.InputMedia?, replyMarkup: Api.ReplyMarkup?, entities: [Api.MessageEntity]?, richMessage: Api.InputRichMessage?) -> (FunctionDescription, Buffer, DeserializeFunctionResponse<Api.Bool>) {
        let buffer = Buffer()
        buffer.appendInt32(-1541162159)
        serializeInt32(flags, buffer: buffer, boxed: false)
        id.serialize(buffer, true)
...
public extension Api.functions.messages {
    static func editMessage(flags: Int32, peer: Api.InputPeer, id: Int32, message: String?, media: Api.InputMedia?, replyMarkup: Api.ReplyMarkup?, entities: [Api.MessageEntity]?, scheduleDate: Int32?, scheduleRepeatPeriod: Int32?, quickReplyShortcutId: Int32?, richMessage: Api.InputRichMessage?) -> (FunctionDescription, Buffer, DeserializeFunctionResponse<Api.Updates>) {
        let buffer = Buffer()
        buffer.appendInt32(-1324947860)
        serializeInt32(flags, buffer: buffer, boxed: false)
        peer.serialize(buffer, true)
        serializeInt32(id, buffer: buffer, boxed: false)
        if Int(flags) & Int(1 << 11) != 0 {
...
public extension Api.functions.messages {
    static func importChatInvite(hash: String) -> (FunctionDescription, Buffer, DeserializeFunctionResponse<Api.messages.ChatInviteJoinResult>) {
        let buffer = Buffer()
        buffer.appendInt32(-560905362)
        serializeString(hash, buffer: buffer, boxed: false)
        return (FunctionDescription(name: "messages.importChatInvite", parameters: [("hash", ConstructorParameterDescription(hash))]), buffer, DeserializeFunctionResponse { (buffer: Buffer) -> Api.messages.ChatInviteJoinResult? in
            let reader = BufferReader(buffer)
            var result: Api.messages.ChatInviteJoinResult?
            if let signature = reader.readInt32() {
                result = Api.parse(reader, signature: signature) as? Api.messages.ChatInviteJoinResult
...
public extension Api.functions.messages {
    static func searchGlobal(flags: Int32, folderId: Int32?, community: Api.InputChannel?, q: String, filter: Api.MessagesFilter, minDate: Int32, maxDate: Int32, offsetRate: Int32, offsetPeer: Api.InputPeer, offsetId: Int32, limit: Int32) -> (FunctionDescription, Buffer, DeserializeFunctionResponse<Api.messages.Messages>) {
        let buffer = Buffer()
        buffer.appendInt32(1629922364)
        serializeInt32(flags, buffer: buffer, boxed: false)
        if Int(flags) & Int(1 << 0) != 0 {
            serializeInt32(folderId!, buffer: buffer, boxed: false)
        }
...
public extension Api.functions.messages {
    static func sendMessage(flags: Int32, peer: Api.InputPeer, replyTo: Api.InputReplyTo?, message: String, randomId: Int64, replyMarkup: Api.ReplyMarkup?, entities: [Api.MessageEntity]?, scheduleDate: Int32?, scheduleRepeatPeriod: Int32?, sendAs: Api.InputPeer?, quickReplyShortcut: Api.InputQuickReplyShortcut?, effect: Int64?, allowPaidStars: Int64?, suggestedPost: Api.SuggestedPost?, richMessage: Api.InputRichMessage?) -> (FunctionDescription, Buffer, DeserializeFunctionResponse<Api.Updates>) {
        let buffer = Buffer()
        buffer.appendInt32(-17526942)
        serializeInt32(flags, buffer: buffer, boxed: false)
        peer.serialize(buffer, true)
        if Int(flags) & Int(1 << 0) != 0 {
            replyTo!.serialize(buffer, true)
...
public extension Api.functions.messages {
    static func setBotGuestChatResult(queryId: Int64, result: Api.InputBotInlineResult) -> (FunctionDescription, Buffer, DeserializeFunctionResponse<Api.InputBotInlineMessageID>) {
        let buffer = Buffer()
        buffer.appendInt32(-1192163613)
        serializeInt64(queryId, buffer: buffer, boxed: false)
        result.serialize(buffer, true)
        return (FunctionDescription(name: "messages.setBotGuestChatResult", parameters: [("queryId", ConstructorParameterDescription(queryId)), ("result", ConstructorParameterDescription(result))]), buffer, DeserializeFunctionResponse { (buffer: Buffer) -> Api.InputBotInlineMessageID? in
            let reader = BufferReader(buffer)
            var result: Api.InputBotInlineMessageID?
            if let signature = reader.readInt32() {
                result = Api.parse(reader, signature: signature) as? Api.InputBotInlineMessageID
            }
            return result
        })
    }
...
public extension Api.functions.messages {
    static func translateRichMessage(flags: Int32, peer: Api.InputPeer?, id: [Int32]?, text: [Api.InputRichMessage]?, toLang: String, tone: String?) -> (FunctionDescription, Buffer, DeserializeFunctionResponse<Api.messages.TranslatedRichMessage>) {
        let buffer = Buffer()
        buffer.appendInt32(441720836)
        serializeInt32(flags, buffer: buffer, boxed: false)
        if Int(flags) & Int(1 << 0) != 0 {
            peer!.serialize(buffer, true)
        }
        ...
        return (FunctionDescription(name: "messages.translateRichMessage", parameters: [("flags", ConstructorParameterDescription(flags)), ("peer", ConstructorParameterDescription(peer)), ("id", ConstructorParameterDescription(id)), ("text", ConstructorParameterDescription(text)), ("toLang", ConstructorParameterDescription(toLang)), ("tone", ConstructorParameterDescription(tone))]), buffer, DeserializeFunctionResponse { (buffer: Buffer) -> Api.messages.TranslatedRichMessage? in
            let reader = BufferReader(buffer)
            var result: Api.messages.TranslatedRichMessage?
            if let signature = reader.readInt32() {
                result = Api.parse(reader, signature: signature) as? Api.messages.TranslatedRichMessage
            }
            return result
        })
    }
