...
fileprivate let parsers: [Int32 : (BufferReader) -> Any?] = {
    ...
    dict[-1132882121] = { return SecretApi144.Bool.parse_boolFalse($0) }
    dict[-1720552011] = { return SecretApi144.Bool.parse_boolTrue($0) }
    ...
    dict[-860719551] = { return SecretApi144.DecryptedMessageAction.parse_decryptedMessageActionTyping($0) }
    ...
    dict[1790809986] = { return SecretApi144.DecryptedMessageMedia.parse_decryptedMessageMediaDocument($0) }
    ...
    dict[-925956616] = { return SecretApi144.MessageEntity.parse_messageEntityCustomEmoji($0) }
    ...
    dict[852137487] = { return SecretApi144.MessageEntity.parse_messageEntitySpoiler($0) }
    ...
    dict[-44119819] = { return SecretApi144.SendMessageAction.parse_sendMessageCancelAction($0) }
    dict[1653390447] = { return SecretApi144.SendMessageAction.parse_sendMessageChooseContactAction($0) }
    dict[393186209] = { return SecretApi144.SendMessageAction.parse_sendMessageGeoLocationAction($0) }
    dict[-718310409] = { return SecretApi144.SendMessageAction.parse_sendMessageRecordAudioAction($0) }
    dict[-1997373508] = { return SecretApi144.SendMessageAction.parse_sendMessageRecordRoundAction($0) }
    dict[-1584933265] = { return SecretApi144.SendMessageAction.parse_sendMessageRecordVideoAction($0) }
    dict[381645902] = { return SecretApi144.SendMessageAction.parse_sendMessageTypingAction($0) }
    dict[-424899985] = { return SecretApi144.SendMessageAction.parse_sendMessageUploadAudioAction($0) }
    dict[-1884362354] = { return SecretApi144.SendMessageAction.parse_sendMessageUploadDocumentAction($0) }
    dict[-1727382502] = { return SecretApi144.SendMessageAction.parse_sendMessageUploadPhotoAction($0) }
    dict[-1150187996] = { return SecretApi144.SendMessageAction.parse_sendMessageUploadRoundAction($0) }
    dict[-1845219337] = { return SecretApi144.SendMessageAction.parse_sendMessageUploadVideoAction($0) }
    return dict
}()
...
public struct SecretApi144 {
    ...
    public static func serializeObject(_ object: Any, buffer: Buffer, boxed: Swift.Bool) {
        switch object {
        case let _1 as SecretApi144.Bool:
        ...
        case let _1 as SecretApi144.PhotoSize:
            _1.serialize(buffer, boxed)
        case let _1 as SecretApi144.SendMessageAction:
            _1.serialize(buffer, boxed)
        default:
            break
        }
    ...
    public enum Bool {
        ...
        fileprivate static func parse_boolFalse(_ reader: BufferReader) -> Bool? {
            return SecretApi144.Bool.boolFalse
        }
        fileprivate static func parse_boolTrue(_ reader: BufferReader) -> Bool? {
            return SecretApi144.Bool.boolTrue
        }
    }
    ...
    public enum DecryptedMessage {
        ...
        public func serialize(_ buffer: Buffer, _ boxed: Swift.Bool) {
            ...
            case .decryptedMessage(let flags, let randomId, let ttl, let message, let media, let entities, let viaBotName, let replyToRandomId, let groupedId):
                ...
                if Int(flags) & Int(1 << 17) != 0 {
                    serializeInt64(groupedId!, buffer: buffer, boxed: false)
                }
                break
        ...
        fileprivate static func parse_decryptedMessage(_ reader: BufferReader) -> DecryptedMessage? {
            ...
            let _c9 = (Int(_1 ?? 0) & Int(1 << 17) == 0) || _9 != nil
    ...
    public enum DecryptedMessageAction {
        ...
        case decryptedMessageActionTyping(action: SecretApi144.SendMessageAction)
        ...
        fileprivate static func parse_decryptedMessageActionTyping(_ reader: BufferReader) -> DecryptedMessageAction? {
            var _1: SecretApi144.SendMessageAction?
            if let signature = reader.readInt32() {
                _1 = SecretApi144.parse(reader, signature: signature) as? SecretApi144.SendMessageAction
            }
            let _c1 = _1 != nil
            if _c1 {
                return SecretApi144.DecryptedMessageAction.decryptedMessageActionTyping(action: _1!)
            }
            else {
                return nil
            }
